...
company (but not late private companies) from any player during its
own operating round turn.  The purchase price must be at least half
and at most double the private company's face value. For example, the
20円 Arima Railway is sold between 10円 and 40円.
...
\include{scenarios}
\settocdepth{section}
\include{designers_notes}
\include{phase_chart}
\include{tile_manifest}
\include{18xx_diff}
